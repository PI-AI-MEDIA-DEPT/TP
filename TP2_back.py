...
class Detect():
    ...
    def run(self):   
        container = []
        rtsp1 = {"rtsp": "rtsp://192.168.33.8:8554/mystream", "cam_id":2, "model":"best.pt"}
        rtsp2 = {"rtsp": "rtsp://192.168.33.9:8554/mystream", "cam_id":3, "model":"best.pt"}
        ...
        recode_out = cv2.VideoWriter('appsrc ! videoconvert' + \
                    ...
                    ' ! rtspclientsink location={}'.format("rtsp://127.0.0.1:8554/back"),
